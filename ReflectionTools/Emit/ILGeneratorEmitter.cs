...
#endif
    /// <summary>
    /// Creates an <see cref="IOpCodeEmitter"/> wrapper from an <see cref="ILGenerator"/>.
    /// </summary>
    public static implicit operator ILGeneratorEmitter(ILGenerator generator) => new ILGeneratorEmitter(generator);

    /// <summary>
    /// Gets the underlying <see cref="ILGenerator"/> from an <see cref="IOpCodeEmitter"/> wrapper.
    /// </summary>
