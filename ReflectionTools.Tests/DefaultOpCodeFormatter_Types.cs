...
public class DefaultOpCodeFormatter_Types
{
    ...
    [DataRow(typeof(IEnumerable<NestedClass>), "IEnumerable<DefaultOpCodeFormatter_Types.NestedClass>")]
    ...
    [DataRow(typeof(IEnumerable<NestedClass>), "System.Collections.Generic.IEnumerable<DanielWillett.ReflectionTools.Tests.DefaultOpCodeFormatter_Types.NestedClass>")]
    [DataRow(typeof(void*), "void*")]
    [DataRow(typeof(int*), "int*")]
    ...
    [DataRow(typeof(IEnumerable<NestedClass>), "public interface IEnumerable<DefaultOpCodeFormatter_Types.NestedClass>")]
    ...
    [DataRow(typeof(IEnumerable<NestedClass>), "public interface System.Collections.Generic.IEnumerable<DanielWillett.ReflectionTools.Tests.DefaultOpCodeFormatter_Types.NestedClass>")]
